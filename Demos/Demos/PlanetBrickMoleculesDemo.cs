...
/// </summary>
public class PlanetBrickMoleculesDemo : Demo
{
    ...
    public override void Initialize(ContentArchive content, Camera camera)
    {
        ...
        var orbiterLength = 1.0f * 2;
        var orbiterWidth = 0.5f * 2;
        var orbiterHeight = 0.25f * 2;
        ...
        var orbiter = new Box(orbiterWidth, orbiterHeight, orbiterLength);
